...
if type docker-compose > /dev/null 2>&1; then
    ...
    #Docker compose doesn't release an x86_64 version anymore - just AMD64.  Convert it here.
    ...
    if [ "${TARGET_COMPOSE_ARCH}" != "x86_64" ]; then
        ...
        echo "Getting https://github.com/docker/compose/releases/download/${LATEST_COMPOSE_VERSION}/docker-compose-$(uname -s)-${TARGET_COMPOSE_ARCH}" 
